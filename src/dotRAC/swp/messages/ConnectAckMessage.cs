...
{
    public class ConnectAckMessage : IServiceWireMessage
    {
        private readonly IDictionary<string, object> parameters;

        public IDictionary<string, object> Parameters => new ReadOnlyDictionary<string, object>(parameters);

        public MessageType Type => MessageType.CONNECT_ACK;

        public ConnectAckMessage(IDictionary<string, object> parameters)
        {
